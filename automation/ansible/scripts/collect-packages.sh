...
REMOTE_PROJECT_DIR="/opt/simple-sftpd"
...
- name: Collect packages from remote VMs
  ...
  gather_facts: no
  vars:
    project_dir: "/opt/simple-sftpd"
    remote_dist_dir: "/opt/simple-sftpd/dist"
    remote_build_dir: "/opt/simple-sftpd/build"
    remote_centralized_dir: "/opt/simple-sftpd/dist/centralized/v$VERSION"
